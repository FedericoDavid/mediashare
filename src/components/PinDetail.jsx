...
import { pinDetailMorePinQuery, pinDetailQuery } from '../utils/useUserQuery';
        ...
        >
          ...
          <div className='w-full p-5 flex-1 xl:min-w-620'>
            ...
            <div className='max-h-370 overflow-y-auto'>
              {pinDetail?.comments?.map((c) => (
                <div className='flex gap-2 mt-5 items-center bg-white rounded-lg' key={c.comment}>
                  <img
              ...
              >
                {addingComment ? (
                  <span className='flex flex-row w-full justify-between'>
                    <Loader type='TailSpin' color='#fff' height={20} width={20} className='mr-2' />
                  </span>
                ) : (
                  'Post'
                )}
